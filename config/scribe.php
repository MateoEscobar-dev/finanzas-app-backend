...
return [
    ...
    'description' => 'API REST del sistema de finanzas personales. Proporciona endpoints para autenticación, gestión de usuarios, menús y roles con permisos granulares.',
    ...
    'routes' => [
        [
            ...
            'exclude' => [
                'GET api/', // Fallback de autenticación (no documentable)
            ],
        ],
    ],
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtén tu token autenticándote en <code>POST /api/login</code> e inclúyelo como <b>Bearer Token</b> en el header <code>Authorization</code>.',
    ],
    ...
    // Deshabilitado para evitar problemas con EncryptableTrait y datos AES durante la generación
