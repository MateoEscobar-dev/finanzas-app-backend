...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'password'         => ['nullable', 'string', new ValidAesEncryptedPassword(enforceComplexity: true)],
            'phone'            => ['nullable', 'string', 'regex:/^\+[1-9]\d{1,14}$/'],
            'phone_ext'        => ['nullable', 'numeric', 'digits_between:1,10'],
            'birth_day'        => ['nullable', 'date_format:Y-m-d', 'before_or_equal:' . now()->subYears(18)->format('Y-m-d')],
